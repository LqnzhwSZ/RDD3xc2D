package de.lambeck.pned.filesystem.pnml.org;
 ...
 */
public final class PNMLWriter_org {
    ...
    public static void main(final String[] args) {
        if (args.length > 0) {
            ...
            PNMLWriter_org pnmlWriter = new PNMLWriter_org(pnmlDatei);
     ...
     */
    public PNMLWriter_org(final File pnml) {
        super();
     ...
     */
    public void addTransition(final String id, final String label, final String xPosition, final String yPosition) {
        if (writer != null) {
            try {
     ...
     */
    public void addPlace(final String id, final String label, final String xPosition, final String yPosition,
